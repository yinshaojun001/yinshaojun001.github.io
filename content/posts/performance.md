...
# 📘 性能与负载 入门名词描述[#](#-性能与负载-入门名词描述)

> “没有解决方案，只有利弊权衡。尽你所能获取最好的利弊权衡，这是你唯一能指望的事。”
> ——《DDIA》

## 🧩 一、什么是负载（Load）[#](#-一什么是负载load)
...
### 🔢 一、QPS 和 TPS 的区别与联系[#](#-一qps-和-tps-的区别与联系)
...
### 📊 二、P99 / P999 / P95 的含义[#](#-二p99--p999--p95-的含义)

### 📌 定义：百分位响应时间指标（Percentiles）[#](#-定义百分位响应时间指标percentiles)
...
### 🚨 为什么不用平均值（Average）？[#](#-为什么不用平均值average)
...
## ⚙️ 二、如何描述性能（Performance）[#](#-二如何描述性能performance)
...
### ⏱️ 2. 延迟与响应时间（Latency / Response Time）[#](#-2-延迟与响应时间latency--response-time)
...
## 🏗️ 五、系统设计视角下的性能保障[#](#-五系统设计视角下的性能保障)

### 🎯 设计高并发、高吞吐接口的原则[#](#-设计高并发高吞吐接口的原则)
