...
draft = false
slug = "捋一下jmm"
tags = ["Java", "JVM", "并发", "性能优化"]
series = []
summary = "Java Memory Model（JMM）与 JVM 运行时内存区域详解 一、Java Memory Model（JMM）概述 JMM（Java Memory Model）是 Java 虚拟机规范中定义的线程之间如何共…"
+++

# Java Memory Model（JMM）与 JVM 运行时内存区域详解
